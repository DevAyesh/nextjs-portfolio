                    ...
                    <div className="d-flex justify-content-between align-items-start mb-2">
                      ...
                      <div className="project-tech-icons">
                        {project.icons.map((icon, i) => {
                          const IconMap = { FaPython, FaDocker, FaRobot, FaAws, FaServer, FaReact, FaBootstrap, FaCode, FaMicrochip, FaNodeJs, FaDatabase, FaHtml5, FaCss3Alt, SiMongodb, SiExpress, SiNextdotjs, FaJava, FaAndroid, SiFirebase, SiPandas };
